		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
					I am a DevOps Engineer and looking to get crazy challenges in the role. Excited to become an integral part of an organization. 
                    {/* and make a significant contribution to its innovations. */}
					</h1>
					<div className={styles.btn}>
						<a
							href='https://drive.google.com/file/d/1LWn59ZvlOKzbQUAuPPUH0VRJl4GM4-5T/view?usp=share_link' // Resume
							target='blank'
						>
							<Button
								text={
